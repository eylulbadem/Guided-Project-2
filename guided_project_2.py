...
Original file is located at
    https://colab.research.google.com/drive/1DaxLMYfwYhB5m83_a8jOVcRJtiLVh_u_
...
HI_company1.update_num_clients(157)
...
class Logistics:
    ...
    def print_report(self):
      print(f"""
      The company {self.company_name}, was founded in {self.foundation_year}. The founder of the company is {self.founder_name}.
      Company slogan: {self.company_slogan}
    ...
    def update_inventory_space(self, new_inventory_space):
      ...
      print(f"inventory space is now {self.inventory_space}!")
...
class Trading:
    ...
    def update_sales_and_expenses(self, new_sales, new_expenses):
      ...
      print(f"sales is now {self.sales} and expenses is now {self.expenses}")
